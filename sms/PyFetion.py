...
FetionLoginXML = """<args><device accept-language="default" machine-code="001676C0E351" /><caps value="1FF" /><events value="7F" /><user-info mobile-no="%s" user-id="%s"><personal version="0" attributes="v4default" /><custom-config version="0"/><contact-list version="0" buddy-attributes="v4default" /></user-info><credentials domains="fetion.com.cn"/><presence><basic value="%s" desc="" /><extendeds /></presence></args>"""
